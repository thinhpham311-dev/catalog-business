...
const SocialsWrapper = styled.div(() => [
    tw`relative h-[40vh] w-full bg-black`,
    css`
        .socials-inner{
            ...
            h1{
                ${tw`xl:text-md lg:text-sm text-xs text-white font-thin relative z-50`}
            }
            .center{
...
const BooksWrapper = styled.div(() => [
    tw`relative py-[10vh] h-[60vh] w-full bg-black `,
    css`
        .container{
        ...
        button.btn-books{
            ${tw`xl:text-4xs lg:text-4xs text-5xs py-[18px] px-[30px] border-0 bg-primary-2 rounded-full mt-[2vw] text-white`}
        }
    `
])
