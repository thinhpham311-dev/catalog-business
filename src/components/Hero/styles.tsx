...
const HeroBottom = styled.div(() => [
    tw`absolute z-10 xl:bottom-0  xl:translate-y-0  bottom-1/2 translate-y-1/2 left-0 h-[auto] xl:py-[15vh] py-0 w-full`,
    css`
        h1{
        ...
        .hero--bottom-inner{
            ...
            &-content{
                ${tw`xl:flex gap-x-[100px] items-start  w-full`}
                &--text{
